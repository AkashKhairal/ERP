...
import { usePermissionsMinimal } from '@/services/permissionServiceMinimal'

const TestMinimalPage = () => {
  const { user } = useAuth()
  const { userPermissions, hasPermission, hasModuleAccess } = usePermissionsMinimal()

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Minimal Permission System Test</h1>
