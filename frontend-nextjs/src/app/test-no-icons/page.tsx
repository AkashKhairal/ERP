...
import { usePermissionsNoIcons } from '@/services/permissionServiceNoIcons'

const TestNoIconsPage = () => {
  const { user } = useAuth()
  const { userPermissions, hasPermission, hasModuleAccess } = usePermissionsNoIcons()

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Permission System Test (No Icons)</h1>
...
export default TestNoIconsPage
